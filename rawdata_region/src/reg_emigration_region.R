...
## Create 'reg_emigration' data frame from 'pxweb_nonbirths'
...
reg_emigration_region <- pxweb_nonbirths %>%
    filter(event == "Out migration") %>%
...
write_csv(reg_emigration_region,
          file = "../data/reg_emigration_region.csv")
